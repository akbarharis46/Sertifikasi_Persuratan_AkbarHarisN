                            ...
                            <form action="<?php echo site_url(); ?>Adminlient/put_process_profile" class="needs-validation" method="POST" enctype="multipart/form-data" onload="setSelectBoxByText()">
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        ...
                                        <img src="<?= base_url('assets/super/img/Haris.jpg') ?>" class="card-img" alt="..." width="100%">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">

                                            <h4 class="card-title text-dark">Aplikasi Ini dibuat Oleh :</h4>
                                            <h5 class="card-title text-dark">Nama : Akbar Haris Nurruzaman</h5>
                                            <h5 class="card-title text-dark">Nim : 1831710185</h5>
                                            <h5 class="card-title text-dark">Tanggal : 25 Oktober 2021</h5>
                                        </div>
                                    </div>
                                </div>
                        </div>
